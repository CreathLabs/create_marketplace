    ...
    >
      ...
      <div className="absolute top-0 left-0 bottom-0 right-0 w-full h-full bg-[#000000CC] text-white flex items-end px-3 md:px-[52px] ">
        <div className="absolute top-0 left-0 right-0 bottom-0 flex justify-center items-center">
          <h1 className=" font-Playfair text-xl md:text-[32px] font-bold ">
            Two Boys, One Lambo
          </h1>
        </div>
        <div className=" md:py-8 w-full grid grid-cols-3 divide-x-2 divide-white ">
          <div className="w-full flex flex-col items-center">
            <h1 className="font-semibold text-lg leading-[45px] text-center ">
              Available Art
            </h1>
            <h1 className="font-bold text-2xl leading-[45px] text-center ">
              12
            </h1>
          </div>
          <div className="w-full flex flex-col items-center">
