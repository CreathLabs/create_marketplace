/*
  ...
  - Added the required column `updated_at` to the `Art` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE "Art" ADD COLUMN     "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
